...
const blackKing = `<svg draggable="true" class="draggable" onload="makeDraggable(evt)" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="${viewBox}">
